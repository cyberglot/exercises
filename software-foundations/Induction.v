...
Proof.
  intros n m. induction n as [| n'].
  Case "n = 0". rewrite plus_O_n. rewrite plus_0_r. reflexivity.
...
Proof.
  ...
  assert (C: n + m = m + n). rewrite plus_comm. reflexivity.
...
Lemma mult_m_Sn: forall m n: nat, m + m * n = m * S n.
Proof.
  intros m n. induction m as [| m'].
  Case "m = 0". reflexivity.
  Case "m = Suc m'". simpl. rewrite plus_swap. rewrite IHm'. reflexivity.
Qed.
...
Proof.
  intros m n. induction m as [| m'].
  Case "m = 0". rewrite mult_0_r. rewrite Basics.mult_0_l. reflexivity.
  Case "m = Suc m'". simpl. rewrite IHm'. rewrite mult_m_Sn. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros b c.
  destruct b.
  Case "b". simpl. destruct c. reflexivity. reflexivity.
  Case "!b". reflexivity.
Qed.
